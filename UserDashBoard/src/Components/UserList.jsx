...
export default class UserList extends React.Component {
    ...
    handleSearch = e => param => {
        ...
        this.setState({
            filteredData: this.state.Data.filter(person => {
            ...
            return (
                <form>
                    <div className='container'>
                        <div className="container__left"><h1>Users</h1></div>
                        <div className="container__right">
                            <div className="container__column"><label>Search</label>
                                ...
                                <input
                                    ...
                                    onChange={(this.handleSearch('Search'))}
                                /></div>
                            <div className="container__column"><label>Sort By</label>
